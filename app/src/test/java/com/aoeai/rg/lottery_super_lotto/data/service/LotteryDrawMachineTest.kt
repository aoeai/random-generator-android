...
class LotteryDrawMachineTest{
    ...
    fun `front area contains 1 to 35 numbers`() {
        ...
        for (i in 1..35) {
            Assertions.assertThat(frontArea).contains(i)
        }
    }
    ...
    fun `draw 5 front area balls`() {
        ...
        Assertions.assertThat(frontAreaBalls).hasSize(5)
    }
    ...
    fun `draw front area balls without duplicate numbers`() {
        ...
        Assertions.assertThat(frontAreaBalls).doesNotHaveDuplicates()
    }
    ...
    fun `draw front area balls in ascending order`() {
        ...
        Assertions.assertThat(frontAreaBalls).isSorted()
    }
    ...
    fun `back area contains 1 to 12 numbers`() {
        ...
        for (i in 1..12) {
            Assertions.assertThat(backArea).contains(i)
        }
    }
    ...
    fun `draw 2 back area balls`() {
        ...
        Assertions.assertThat(backAreaBalls).hasSize(2)
    }
    ...
    fun `draw back area balls without duplicate numbers`() {
        ...
        Assertions.assertThat(backAreaBalls).doesNotHaveDuplicates()
    }
    ...
    fun `draw back area balls in ascending order`() {
        ...
        Assertions.assertThat(backAreaBalls).isSorted()
    }
}